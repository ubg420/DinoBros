...
var Storage={};Storage.VERSION=1;Storage.PATH_VERSION='com.martinmagni.dinobros/version';Storage.PREFIX='com.martinmagni.dinobros/data/';Storage.LEGACY_PREFIX='/';Storage.stringToHex=function(str){var hex='';for(var i=0;i<str.length;i++){hex+=str.charCodeAt(i).toString(16)+" ";}
return hex;}
...
function initPokiSdk(){if(!pokiDebug)console.log("no debug")
...
function pokiSendLevelData(){console.log("leveldata")}
